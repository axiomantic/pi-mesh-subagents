...
describe("subagent prompt runtime", () => {
	...
	it("strips the subagent orchestration skill even when inherited skills remain", () => {
		...
		assert.ok(!rewritten.includes("<name>pi-mesh-subagents</name>"));
		assert.ok(!rewritten.includes("delegate to subagents"));
	});

	it("strips explicit pi-mesh-subagents skill injection from child prompts", () => {
		const prompt = "Before\n\n<skill name=\"pi-mesh-subagents\">\nDo not keep this.\n</skill>\n\n<skill name=\"safe-bash\">\nKeep this.\n</skill>\nAfter";
